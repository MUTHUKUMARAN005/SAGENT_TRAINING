...
import { FiActivity, FiThermometer, FiWind, FiHeart } from 'react-icons/fi';
...
const MyHealthRecords = () => {
  ...
  const getColor = (type, value) => {
    if (type === 'heart' && value > 120) return '#ef4444';
    if (type === 'heart' && value > 100) return '#f59e0b';
              ...
              <div style={{
                ...
                >
                  <FiHeart style={{
                    ...
                    color: getColor('heart', record.heartRate),
                  }} />
