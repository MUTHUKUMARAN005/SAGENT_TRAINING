...
const AppRoutes = () => {
  ...
  // Public routes
  if (['/login', '/register', '/forgot-password', '/unauthorized'].includes(location.pathname)) {
    return (
        ...
        <AnimatePresence mode="wait">
          <Routes location={location} key={location.pathname}>
            ...
            <Route path="/members" element={
              <RouteGuard permissions={[PERMISSIONS.VIEW_MEMBERS, PERMISSIONS.VIEW_OWN_PROFILE]}>
                <Members />
              </RouteGuard>
            } />
            <Route path="/categories" element={
              <RouteGuard permission={PERMISSIONS.VIEW_CATEGORIES}><Categories /></RouteGuard>
            } />
            ...
            <Route path="/reports" element={
              <RouteGuard permission={PERMISSIONS.VIEW_REPORTS}><Reports /></RouteGuard>
            } />
            <Route path="/profile" element={
              <RouteGuard permission={PERMISSIONS.VIEW_PROFILE}><Profile /></RouteGuard>
            } />
            <Route path="/assistant" element={
              <RouteGuard permission={PERMISSIONS.USE_AI_ASSISTANT}><AIAssistant /></RouteGuard>
            } />
