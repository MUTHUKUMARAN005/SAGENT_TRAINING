      ...
      return (
        ...
        >
          <motion.div
            ...
            style={{ width: '70px', height: '70px', margin: '0 auto 12px', borderRadius: '20px',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: '13px', fontWeight: 800, color: '#fca5a5',
              border: '1px solid rgba(239,68,68,0.28)', background: 'rgba(239,68,68,0.12)' }}
          >
            LOCKED
          </motion.div>
