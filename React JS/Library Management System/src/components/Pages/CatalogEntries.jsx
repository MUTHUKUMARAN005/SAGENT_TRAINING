...
const CatalogEntries = () => <CrudPage config={{
  entityName:'Catalog Entry', icon:'CG', gradient:'linear-gradient(135deg,#6366f1,#818cf8)', color:'#6366f1',
  ...
  columns:[
    ...
    { header:'Library', render: r => <span style={{ fontSize:'12px' }}>{r.library?.name||'N/A'}</span> },
