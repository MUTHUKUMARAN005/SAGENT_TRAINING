...
import {
  ...
  FiAward, FiMapPin, FiShield, FiZap
} from 'react-icons/fi';
...
const menuItems = [
  {
    ...
    items: [
      ...
      { path: '/ai-assistant', icon: 'FiZap', label: 'AI Assistant', permission: 'DASHBOARD_VIEW' },
    ],
  },
  {
    section: 'Management',
        ...
        return (
          <div key={sIdx} className="sidebar-section">
            ...
            {visibleItems.map((item) => {
              ...
              const itemLabel = isStudentUser && item.path === '/students' ? 'My Profile' : item.label;
              return (
