...
export const ROLE_CONFIG = {
  ADMIN: {
    ...
    sidebar: [
      ...
      { path: '/admin/products', icon: FiShoppingBag, label: 'Products', color: '#ec4899' },
      { path: '/admin/customers', icon: FiUsers, label: 'Customers', color: '#3b82f6' },
      { path: '/admin/orders', icon: FiShoppingCart, label: 'Orders', color: '#10b981' },
      ...
      { path: '/admin/users', icon: FiUserCheck, label: 'Users', color: '#14b8a6' },
