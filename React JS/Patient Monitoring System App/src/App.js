...
import PatientLiveHealthMonitor from './pages/patient/LiveHealthMonitor';
import PatientDailyHealthReports from './pages/patient/DailyHealthReports';
import PatientHealthCharts from './pages/patient/HealthCharts';
...
import DoctorPatientMonitoring from './pages/doctor/PatientMonitoring';
    ...
    <AuthProvider>
      <Router>
        ...
        <Routes>
          ...
          />
          <Route
            path="/patient/live-monitor"
            element={(
              <RoleRoute allowedRoles={['PATIENT']}>
                <PatientLiveHealthMonitor />
              </RoleRoute>
            )}
          />
          <Route
          ...
          />
          <Route
            path="/patient/daily-reports"
            element={(
              <RoleRoute allowedRoles={['PATIENT']}>
                <PatientDailyHealthReports />
              </RoleRoute>
            )}
          />
          <Route
